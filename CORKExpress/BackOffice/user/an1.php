            ...
            <table class="table table-borderless table-striped table-earning">
                ...
                <tbody>
                  <?php
                      ...
                      $dados = mysqli_query($conn,"SELECT idtrabalhador, nome, apelido, nif, nib, niss ,categoria, morada, email, password, username  FROM trabalhadores WHERE idtrabalhador=$_SESSION[idtrabalhador] ");
